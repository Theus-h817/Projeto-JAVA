...
public class Cadastro_Projeto extends javax.swing.JFrame {
    ...
    public Cadastro_Projeto() {
        ...
        addWindowListener(new WindowAdapter() {
            ...
            public void windowClosing(WindowEvent e) {
                ...
                Lista.setContribuicaoID(getContribuicaoID());
    ...
    private int DesenvolvedorID, ContribuicaoID, ProjetoID;
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(jButton_EnviaConteudo, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addGap(46, 46, 46)
                        .addComponent(jButton_LimpaTudo, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        ...
        jLabel5.setText("LINGUAGENS DE PROGRAMAÇÃO USADAS");

        jComboBox_ListaLinguagemProgramacao.addItemListener(new java.awt.event.ItemListener() {
            public void itemStateChanged(java.awt.event.ItemEvent evt) {
                jComboBox_ListaLinguagemProgramacaoItemStateChanged(evt);
            }
        });
        ...
        jScrollPane4.setViewportView(jTable_LinguagensUtilizadas);
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        jTable_LinguagensUtilizadas.setVisible(false);
    ...
    private void jButton_EnviaConteudoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton_EnviaConteudoMouseClicked
        int resposta = 0;
        if (FoiEnviado == false){
                resposta = JOptionPane.showConfirmDialog(null, "Os dados estão corretos? Após a confirmação não é possível editar o texto por aqui, somente as linguagens de programação",
                "confirmação", JOptionPane.YES_NO_OPTION, JOptionPane.WARNING_MESSAGE);
        }
        if (resposta == JOptionPane.YES_OPTION && FoiEnviado == false) {
            String nome_projeto = jTextField_CadastroNomeProjeto.getText();
            String descricao_projeto = jTextArea_CadastroDescricaoProjeto.getText();
            String codigo_projeto = jTextArea_CadastroCodigoProjeto.getText();
            int ID = getDesenvolvedorID();
            String NomeDev = getNome();

            if (nome_projeto.isEmpty() || descricao_projeto.isEmpty() || codigo_projeto.isEmpty()) {
                JOptionPane.showMessageDialog(null, "Por favor, preencha todos os campos obrigatórios.", "Alerta", JOptionPane.ERROR_MESSAGE);
                return;
            }
            devDTO = new DesenvolvedorDTO();
            devDTO.setNome_do_Projeto(nome_projeto);
            devDTO.setDescricao_do_Projeto(descricao_projeto);
            devDTO.setCodigo_do_Projeto(codigo_projeto);
            devDTO.setDesenvolvedorID(ID);
            devDTO.setNome(NomeDev);

            DesenvolvedorDAO devDAO = new DesenvolvedorDAO();
            devDAO.cadastrarNomeProjeto(devDTO);
            devDAO.cadastrarCodigoProjeto(devDTO);
            setContribuicaoID(devDTO.getContribuicaoID());
            setProjetoID(devDTO.getProjetoID());
            ...
            jTable_LinguagensUtilizadas.setVisible(true);
            FoiEnviado = true;
        } else if (FoiEnviado == true) {
            JOptionPane.showMessageDialog(null, "Projeto já cadastrado é possível somente a edição de linguagem de programação, para editá-lo, dá na opção de edição na página principal",
                    "Alerta", JOptionPane.ERROR_MESSAGE);
            jTextField_CadastroNomeProjeto.enable(false);
            jTextArea_CadastroDescricaoProjeto.enable(false);
            jTextArea_CadastroCodigoProjeto.enable(false);
            jButton_EnviaConteudo.enable(false);
            jButton_LimpaTudo.enable(false);
        }
    }//GEN-LAST:event_jButton_EnviaConteudoMouseClicked


    private void jComboBox_ListaLinguagemProgramacaoItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jComboBox_ListaLinguagemProgramacaoItemStateChanged
        int selectedIndex = jComboBox_ListaLinguagemProgramacao.getSelectedIndex() + 1;
        if (selectedIndex >= 0) {
            devDTO = new DesenvolvedorDTO();
            devDTO.setLinguagemEscolhidaID(selectedIndex);
        }
// TODO add your handling code here:
    }//GEN-LAST:event_jComboBox_ListaLinguagemProgramacaoItemStateChanged
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Cadastro_Projeto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Cadastro_Projeto().setVisible(true);
            }
        });
    }
